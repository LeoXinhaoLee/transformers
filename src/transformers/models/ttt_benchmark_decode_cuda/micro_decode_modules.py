...
if __name__ == "__main__":
    ...
    if not test_cg:
        ...
        # print(torch.abs(original_state_dict['W1'] - triton_state_dict['W1']).max())
        # print(torch.abs(original_state_dict['W1_grad'] - triton_state_dict['W1_grad']).max())
    ...
    # print('Output diff: max={}  median={}'.format(torch.abs(XCW_batch_pt - XCW_batch_cuda).max(),
    #                                               torch.abs(XCW_batch_pt - XCW_batch_cuda).median()))
    ...
    # print('Output diff: max={}  median={}'.format(torch.abs(XCW_batch_pt - XCW_batch_triton).max(),
    #                                               torch.abs(XCW_batch_pt - XCW_batch_triton).median()))
